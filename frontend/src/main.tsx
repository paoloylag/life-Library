...
import { BarChart3, Bell, ChevronRight, Clock3, LayoutDashboard, Maximize2, Menu, Minimize2, Moon, QrCode, Search, Settings, Sun, UserPlus, Users, X } from 'lucide-react'
...
function QrDisplay({close}:{close:()=>void}){
 const settings=loadSettings(),stored=localStorage.getItem('qr')
 const url=Number(localStorage.getItem('qr-expires')||Infinity)>Date.now()?stored:null
