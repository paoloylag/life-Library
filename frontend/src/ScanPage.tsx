...
const backendEnabled=import.meta.env.DEV||import.meta.env.VITE_BACKEND_ENABLED==='true'||Boolean(configuredApi)
...
export default function ScanPage(){
 ...
 const[autoCheckInStarted,setAutoCheckInStarted]=React.useState(false)
 ...
 React.useEffect(()=>{
  if(!verifiedUser||!token||expired||autoCheckInRef.current)return
  autoCheckInRef.current=true
  setAutoCheckInStarted(true)
  void recordAuthenticated()
 },[authUser,token,expired])
