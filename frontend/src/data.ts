...
export const programs=['BS-ENTREP','BS-ENTREP-FE','BS-ENTREP-TE','BS-ENTREP-SE','BS-ENTREP-AE','BS-ENTREP-CE']
export const sections=['1A','1B','2A','2B']
...
{name:'Angela Reyes',number:'LC-2026-00124',userType:'Student',program:programs[0],yearLevel:'1st Year',section:'1A',department:''},
{name:'Marcus Lim',number:'LC-2025-00817',userType:'Student',program:programs[1],yearLevel:'2nd Year',section:'1B',department:''},
{name:'Sofia Navarro',number:'LC-2024-00309',userType:'Student',program:programs[2],yearLevel:'3rd Year',section:'2A',department:''},
{name:'Daniel Cruz',number:'LC-2023-00542',userType:'Student',program:programs[0],yearLevel:'4th Year',section:'2B',department:''},
{name:'Mika Santos',number:'LC-2025-00288',userType:'Student',program:programs[3],yearLevel:'2nd Year',section:'1B',department:''},
{name:'Paolo Garcia',number:'LC-2024-00911',userType:'Student',program:programs[1],yearLevel:'3rd Year',section:'2A',department:''},
{name:'Nina Flores',number:'LC-2026-00417',userType:'Student',program:programs[2],yearLevel:'1st Year',section:'1A',department:''},
{name:'Ethan Ramos',number:'LC-2023-00726',userType:'Student',program:programs[0],yearLevel:'4th Year',section:'2B',department:''},
