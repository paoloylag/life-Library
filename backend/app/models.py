...
class StudentProfile(Base):
    ...
    employment_status: Mapped[str | None] = mapped_column(String(80))
    position: Mapped[str | None] = mapped_column(String(180))
    middle_name: Mapped[str | None] = mapped_column(String(120))
    immediate_supervisor: Mapped[str | None] = mapped_column(String(180))
    date_hired: Mapped[str | None] = mapped_column(String(80))
    regularization_date: Mapped[str | None] = mapped_column(String(80))
    contact_number: Mapped[str | None] = mapped_column(String(80))
